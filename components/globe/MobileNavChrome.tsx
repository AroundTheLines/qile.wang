...
export default function MobileNavChrome({ mode }: Props) {
  ...
  return (
    <button
      onClick={onClick}
      aria-label={label}
      className="flex items-center gap-2 px-4 py-3 w-full text-left text-xs tracking-widest uppercase bg-white dark:bg-black border-b border-gray-100 dark:border-gray-900 hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-inset"
      data-no-skeleton
    >
